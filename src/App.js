  ...
  render() {
    ...
    let Excercise = {
      ...
      transformationRules:[
        ...
        {label:"Ф<sub>0</sub>↔Ф<sub>1</sub>≡((¬(Ф<sub>0</sub>)∨Ф<sub>1</sub>)∧(¬(Ф<sub>1</sub>)∨Ф<sub>0</sub>))", value:"a↔b≡(¬(a)∨b)∧(¬(b)∨a)"},
        {label:"Ф<sub>0</sub>∨(Ф<sub>1</sub>∧Ф<sub>2</sub>)≡(Ф<sub>0</sub>∨Ф<sub>1</sub>)∧(Ф<sub>0</sub>∨Ф<sub>2</sub>)", value:"a∨(b∧c)≡(a∨b)∧(a∨c)"},
        {label:"Ф<sub>0</sub>∧(Ф<sub>1</sub>∨Ф<sub>2</sub>)≡(Ф<sub>0</sub>∧Ф<sub>1</sub>)∨(Ф<sub>0</sub>∧Ф<sub>2</sub>)", value:"a∧(b∨c)≡(a∧b)∨(a∧c)"},
        {label:"¬(Ф<sub>0</sub>∧Ф<sub>1</sub>)≡(¬(Ф<sub>0</sub>)∨¬(Ф<sub>1</sub>))",value:"¬(a∧b)≡(¬(a)∨¬(b))"},
        {label:"¬(Ф<sub>0</sub>∨Ф<sub>1</sub>)≡(¬(Ф<sub>0</sub>)∧¬(Ф<sub>1</sub>))",value:"¬(a∨b)≡(¬(a)∧¬(b))"},
